...
//TODO  if (LCD_Cell_Colour(x_min, x_max, y_min, y_max, text_colour, cell_colour) !=
//      0) {
...
//  }
  ...
  //TODO BSP_LCD_DisplayStringAt(x_pos, y_pos,
  //TODO                        (uint8_t *)grid_space_p.items[cell_number + offset],
  //TODO                        CENTER_MODE);
